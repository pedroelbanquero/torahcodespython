...
allModules = [["conversions","conversions Torah"],["query","query in db"],["shemhemaphoresh","module shemhemaphoresh"]]


textToModule = [["conversions", conversions], ["query", query], ["shemhemaphoresh", shemhemaphoresh]]
